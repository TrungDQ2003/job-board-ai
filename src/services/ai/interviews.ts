...
- IMPORTANT: You MUST write the entire evaluation feedback, category ratings, overall rating, strengths, and areas for improvement in ${language === "vi" ? "Vietnamese (Tiếng Việt)" : "English"}.`,
  })
