...
- IMPORTANT: You MUST write the entire question and output text in ${language === "vi" ? "Vietnamese (Tiếng Việt)" : "English"}.`,
  })
}
...
- IMPORTANT: You MUST write the entire rating comments, feedback, and correct answer in ${language === "vi" ? "Vietnamese (Tiếng Việt)" : "English"}.
