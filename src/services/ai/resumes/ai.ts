...
Current Date: ${new Date().toLocaleDateString("en-US", { year: 'numeric', month: 'long', day: 'numeric' })} (Use this date to determine if experience, education, or certificates are in the past, present, or future).
...
- IMPORTANT: You MUST write the entire JSON response text fields (such as 'summary', feedback 'name', and feedback 'message') in ${language === "vi" ? "Vietnamese (Tiếng Việt)" : "English"}.
`,
  })
}
